...
class FingerprintApi:
    ...
    def delete_visitor_data_with_http_info(self, visitor_id: str, **kwargs):  # noqa: E501
        ...
        query_params = [('ii', 'fingerprint-pro-server-python-sdk/8.14.0')]
    ...
    def get_visits(self, visitor_id: str, **kwargs) -> Union[VisitorsGetResponse, AsyncResult[VisitorsGetResponse]]:  # noqa: E501
        ...
        :param async_req bool
        :param visitor_id: Unique [visitor identifier](https://dev.fingerprint.com/reference/get-function#visitorid) issued by Fingerprint Identification and all active Smart Signals. (required)
        ...
        :param limit: Limit scanned results.  `GET /visitors/{visitor_id}` currently returns at most one visit. Use `GET /events/search` for paginated multi-event queries. 
        :param pagination_key: Deprecated pagination parameter retained for backward compatibility.  `GET /visitors/{visitor_id}` currently returns at most one visit, so pagination is not expected. Use `GET /events/search` for paginated results. 
        :param before: ⚠️ Deprecated pagination method, please use `paginationKey` instead. Timestamp (in milliseconds since epoch) used to paginate results. `GET /visitors/{visitor_id}` currently returns at most one visit, so pagination is not expected. 
    ...
    def get_visits_with_http_info(self, visitor_id: str, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str visitor_id: Unique [visitor identifier](https://dev.fingerprint.com/reference/get-function#visitorid) issued by Fingerprint Identification and all active Smart Signals. (required)
        ...
        :param int limit: Limit scanned results.  `GET /visitors/{visitor_id}` currently returns at most one visit. Use `GET /events/search` for paginated multi-event queries. 
        :param str pagination_key: Deprecated pagination parameter retained for backward compatibility.  `GET /visitors/{visitor_id}` currently returns at most one visit, so pagination is not expected. Use `GET /events/search` for paginated results. 
        :param int before: ⚠️ Deprecated pagination method, please use `paginationKey` instead. Timestamp (in milliseconds since epoch) used to paginate results. `GET /visitors/{visitor_id}` currently returns at most one visit, so pagination is not expected. 
        :return: VisitorsGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def search_events_with_http_info(self, limit: int, **kwargs):  # noqa: E501
        ...
        :param str visitor_id: Unique [visitor identifier](https://dev.fingerprint.com/reference/get-function#visitorid) issued by Fingerprint Identification and all active Smart Signals. Filter for events matching this `visitor_id`. 
        ...
        :param bool reverse: When `true`, sort events oldest first (ascending timestamp order). Default is newest first (descending timestamp order). 
