...
class Emulator(BaseModel):
    ...
    def __init__(self, result=None):  # noqa: E501
        """Emulator - a model defined in Swagger"""  # noqa: E501
        self._result = None
    ...
    def result(self) -> bool:
        """Gets the result of this Emulator.  # noqa: E501
        ...
        :return: The result of this Emulator.  # noqa: E501
        """
        return self._result

    @result.setter
    def result(self, result: bool):
        """Sets the result of this Emulator.

        Android specific emulator detection. There are 2 values:    * `true` - Emulated environment detected (e.g. launch inside of AVD).    * `false` - No signs of emulated environment detected or the client is not Android.   # noqa: E501

        :param result: The result of this Emulator.  # noqa: E501
        """
        if result is None:
