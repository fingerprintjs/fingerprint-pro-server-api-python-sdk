...
class ErrorVisitor404ResponseError(object):
    ...
    def __init__(self, code=None, message=None):  # noqa: E501
        """ErrorVisitor404ResponseError - a model defined in Swagger"""  # noqa: E501
        self._code = None
        self._message = None
    ...
    def code(self, code):
        ...
        allowed_values = ["VisitorNotFound"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ErrorVisitor404ResponseError, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ErrorVisitor404ResponseError):
            return False
