...
class Frida(BaseModel):
    ...
    def __init__(self, result=None):  # noqa: E501
        """Frida - a model defined in Swagger"""  # noqa: E501
        self._result = None
    ...
    def result(self) -> bool:
        """Gets the result of this Frida.  # noqa: E501
        ...
        :return: The result of this Frida.  # noqa: E501
        """
        return self._result

    @result.setter
    def result(self, result: bool):
        """Sets the result of this Frida.

        [Frida](https://frida.re/docs/) detection for Android and iOS devices. There are 2 values:   * `true` - Frida detected   * `false` - No signs of Frida or the client is not a mobile device.   # noqa: E501

        :param result: The result of this Frida.  # noqa: E501
        """
        if result is None:
