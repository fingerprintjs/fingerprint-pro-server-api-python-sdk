...
class ErrorUpdateEvent400ResponseError(object):
    ...
    def to_dict(self):
        ...
        for attr, _ in self.swagger_types.items():
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ErrorUpdateEvent400ResponseError, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ErrorUpdateEvent400ResponseError):
            return False
