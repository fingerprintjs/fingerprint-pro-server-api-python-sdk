...
class ErrorEvent404Response(object):
    ...
    def error(self):
        ...
        :rtype: ErrorEvent404ResponseError
        """
        return self._error
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ErrorEvent404Response, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ErrorEvent404Response):
            return False
