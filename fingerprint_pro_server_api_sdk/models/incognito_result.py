...
class IncognitoResult(object):
    ...
    def __init__(self, result=None):  # noqa: E501
        """IncognitoResult - a model defined in Swagger"""  # noqa: E501
        self._result = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IncognitoResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IncognitoResult):
            return False
