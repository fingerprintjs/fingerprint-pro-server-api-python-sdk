...
class SignalResponseVelocity(object):
    ...
    def __init__(self, data=None, error=None):  # noqa: E501
        """SignalResponseVelocity - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._error = None
    ...
    def to_dict(self):
        ...
        for attr, _ in self.swagger_types.items():
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SignalResponseVelocity, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SignalResponseVelocity):
            return False
