...
class SignalResponseRootApps(object):
    ...
    def __init__(self, data=None, error=None):  # noqa: E501
        """SignalResponseRootApps - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._error = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SignalResponseRootApps, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SignalResponseRootApps):
            return False
