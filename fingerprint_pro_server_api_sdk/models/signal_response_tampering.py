...
class SignalResponseTampering(object):
    ...
    def __init__(self, data=None, error=None):  # noqa: E501
        """SignalResponseTampering - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._error = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SignalResponseTampering, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SignalResponseTampering):
            return False
