...
class Identification(BaseModel):
    ...
    def request_id(self) -> str:
        """Gets the request_id of this Identification.  # noqa: E501

        Unique identifier of the user's request.  # noqa: E501

        :return: The request_id of this Identification.  # noqa: E501
        """
        return self._request_id

    @request_id.setter
    def request_id(self, request_id: str):
        """Sets the request_id of this Identification.

        Unique identifier of the user's request.  # noqa: E501

        :param request_id: The request_id of this Identification.  # noqa: E501
        """
    ...
    def browser_details(self) -> BrowserDetails:
        """Gets the browser_details of this Identification.  # noqa: E501


        :return: The browser_details of this Identification.  # noqa: E501
        """
        return self._browser_details

    @browser_details.setter
    def browser_details(self, browser_details: BrowserDetails):
        """Sets the browser_details of this Identification.


        :param browser_details: The browser_details of this Identification.  # noqa: E501
        """
    ...
    def incognito(self) -> bool:
        """Gets the incognito of this Identification.  # noqa: E501

        Flag if user used incognito session.  # noqa: E501

        :return: The incognito of this Identification.  # noqa: E501
        """
        return self._incognito

    @incognito.setter
    def incognito(self, incognito: bool):
        """Sets the incognito of this Identification.

        Flag if user used incognito session.  # noqa: E501

        :param incognito: The incognito of this Identification.  # noqa: E501
        """
    ...
    @property
    def ip(self) -> str:
        """Gets the ip of this Identification.  # noqa: E501

        IP address of the requesting browser or bot.  # noqa: E501

        :return: The ip of this Identification.  # noqa: E501
        """
        return self._ip

    @ip.setter
    def ip(self, ip: str):
        """Sets the ip of this Identification.

        IP address of the requesting browser or bot.  # noqa: E501

        :param ip: The ip of this Identification.  # noqa: E501
        """
        if ip is None:
    ...
    def ip_location(self) -> Optional[DeprecatedGeolocation]:
        """Gets the ip_location of this Identification.  # noqa: E501


        :return: The ip_location of this Identification.  # noqa: E501
        """
        return self._ip_location

    @ip_location.setter
    def ip_location(self, ip_location: Optional[DeprecatedGeolocation]):
        """Sets the ip_location of this Identification.


        :param ip_location: The ip_location of this Identification.  # noqa: E501
        """
    ...
    def linked_id(self) -> Optional[str]:
        """Gets the linked_id of this Identification.  # noqa: E501

        A customer-provided id that was sent with the request.  # noqa: E501

        :return: The linked_id of this Identification.  # noqa: E501
        """
        return self._linked_id

    @linked_id.setter
    def linked_id(self, linked_id: Optional[str]):
        """Sets the linked_id of this Identification.

        A customer-provided id that was sent with the request.  # noqa: E501

        :param linked_id: The linked_id of this Identification.  # noqa: E501
        """
    ...
    def timestamp(self) -> int:
        ...
        :return: The timestamp of this Identification.  # noqa: E501
        """
        return self._timestamp

    @timestamp.setter
    def timestamp(self, timestamp: int):
        """Sets the timestamp of this Identification.

        Timestamp of the event with millisecond precision in Unix time.  # noqa: E501

        :param timestamp: The timestamp of this Identification.  # noqa: E501
        """
    ...
    def time(self) -> datetime:
        """Gets the time of this Identification.  # noqa: E501
        ...
        :return: The time of this Identification.  # noqa: E501
        """
        return self._time

    @time.setter
    def time(self, time: datetime):
        """Sets the time of this Identification.

        Time expressed according to ISO 8601 in UTC format, when the request from the JS agent was made. We recommend to treat requests that are older than 2 minutes as malicious. Otherwise, request replay attacks are possible.  # noqa: E501

        :param time: The time of this Identification.  # noqa: E501
        """
        if time is None:
    ...
    @property
    def url(self) -> str:
        """Gets the url of this Identification.  # noqa: E501

        Page URL from which the request was sent.  # noqa: E501

        :return: The url of this Identification.  # noqa: E501
        """
        return self._url

    @url.setter
    def url(self, url: str):
        """Sets the url of this Identification.

        Page URL from which the request was sent.  # noqa: E501

        :param url: The url of this Identification.  # noqa: E501
        """
        if url is None:
    ...
    @property
    def tag(self) -> Tag:
        """Gets the tag of this Identification.  # noqa: E501


        :return: The tag of this Identification.  # noqa: E501
        """
        return self._tag

    @tag.setter
    def tag(self, tag: Tag):
        """Sets the tag of this Identification.


        :param tag: The tag of this Identification.  # noqa: E501
        """
        if tag is None:
    ...
    def confidence(self) -> Optional[IdentificationConfidence]:
        """Gets the confidence of this Identification.  # noqa: E501


        :return: The confidence of this Identification.  # noqa: E501
        """
        return self._confidence

    @confidence.setter
    def confidence(self, confidence: Optional[IdentificationConfidence]):
        """Sets the confidence of this Identification.


        :param confidence: The confidence of this Identification.  # noqa: E501
        """
    ...
    def visitor_found(self) -> bool:
        """Gets the visitor_found of this Identification.  # noqa: E501

        Attribute represents if a visitor had been identified before.  # noqa: E501

        :return: The visitor_found of this Identification.  # noqa: E501
        """
        return self._visitor_found

    @visitor_found.setter
    def visitor_found(self, visitor_found: bool):
        """Sets the visitor_found of this Identification.

        Attribute represents if a visitor had been identified before.  # noqa: E501

        :param visitor_found: The visitor_found of this Identification.  # noqa: E501
        """
    ...
    def first_seen_at(self) -> IdentificationSeenAt:
        """Gets the first_seen_at of this Identification.  # noqa: E501


        :return: The first_seen_at of this Identification.  # noqa: E501
        """
        return self._first_seen_at

    @first_seen_at.setter
    def first_seen_at(self, first_seen_at: IdentificationSeenAt):
        """Sets the first_seen_at of this Identification.


        :param first_seen_at: The first_seen_at of this Identification.  # noqa: E501
        """
    ...
    def last_seen_at(self) -> IdentificationSeenAt:
        """Gets the last_seen_at of this Identification.  # noqa: E501


        :return: The last_seen_at of this Identification.  # noqa: E501
        """
        return self._last_seen_at

    @last_seen_at.setter
    def last_seen_at(self, last_seen_at: IdentificationSeenAt):
        """Sets the last_seen_at of this Identification.


        :param last_seen_at: The last_seen_at of this Identification.  # noqa: E501
        """
    ...
    def components(self) -> Optional[RawDeviceAttributes]:
        """Gets the components of this Identification.  # noqa: E501


        :return: The components of this Identification.  # noqa: E501
        """
        return self._components

    @components.setter
    def components(self, components: Optional[RawDeviceAttributes]):
        """Sets the components of this Identification.


        :param components: The components of this Identification.  # noqa: E501
        """
