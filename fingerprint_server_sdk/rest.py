...
from fingerprint_server_sdk.exceptions import ApiException, ApiValueError
...
class RESTResponse(io.IOBase):
    ...
    @property
    def headers(self) -> urllib3.HTTPHeaderDict:
        """Returns a dictionary of response headers."""
        return self.response.headers

    def getheaders(self) -> urllib3.HTTPHeaderDict:
...
class RESTClientObject:
    ...
    def request(
        ...
        return RESTResponse(r)  # type: ignore[arg-type]
