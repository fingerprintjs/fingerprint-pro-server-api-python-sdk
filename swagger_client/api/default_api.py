...
class DefaultApi(object):
    ...
    def visitors_visitor_id_get(self, visitor_id, **kwargs):  # noqa: E501
        """visitors_visitor_id_get  # noqa: E501
        ...
        >>> thread = api.visitors_visitor_id_get(visitor_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.visitors_visitor_id_get_with_http_info(visitor_id, **kwargs)  # noqa: E501
        else:
            (data) = self.visitors_visitor_id_get_with_http_info(visitor_id, **kwargs)  # noqa: E501
            return data

    def visitors_visitor_id_get_with_http_info(self, visitor_id, **kwargs):  # noqa: E501
        """visitors_visitor_id_get  # noqa: E501

        This endpoint allows you to get a history of visits with all available information. Use the visitorID as a URL path parameter. This API method is scoped to a visitor, i.e. all returned information is by visitorId.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.visitors_visitor_id_get_with_http_info(visitor_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method visitors_visitor_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('visitor_id' not in params or
            ...
            raise ValueError("Missing the required parameter `visitor_id` when calling `visitors_visitor_id_get`")  # noqa: E501
